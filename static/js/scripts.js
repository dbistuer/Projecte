...
$(document).ready(function () {
    // add movies to cinema rooms page

    jQuery("select[name='room'] option.room-option").hide();
    jQuery("select[name='cinema']").change(function () {
        var value = jQuery(this).val();
        jQuery("select[name='room'] option.room-option").hide();
        jQuery("select[name='room'] option.cinema-id-" + value).show();
    });
